    ...
    const cards = [
        {
            ...
            description:"Design and implement customized firefighting, fire alarm systems, and evacuation plans to ensure full safety compliance.",
            img: service1
        },
        {
            id:2,
        ...
        },
        {
            ...
            description:"Install addressable and conventional fire alarm devices, including smoke, heat, flame, and gas detectors.",
            img: service3
        },
        {
            id:4,
            title: "Emergency Evacuation Systems",
            description:"Equip buildings with audio evacuation systems, fire-resistant walls, emergency doors, escape ladders, and assembly points.",
            img: service4
        },
        {
            id:5,
            title: "Comprehensive Maintenance Services",
            description:"Ensure system reliability with routine and emergency maintenance for fire safety and prevention systems.",
            img: service5
        },
        {
            id:6,
